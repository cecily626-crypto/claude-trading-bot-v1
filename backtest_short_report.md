# v2.0-Short 策略回测报告
_2026-07-15T04:37:37.695744Z · LBank hour4 · 2000 bars_
```
数据: memecoin 34 个 + trend 2 个, 窗口 2026-01-31->2026-07-15

== S1 破位趋势做空 (memecoins) · FULL | H1 | H2 ==
S1a bo20/reg100/gap3/stop2.5       n= 628  win= 37.4%  PF= 1.19  tot=  +381.1%  avg= +0.61%  hold= 10 | H1 PF= 1.91 tot= +896.2% | H2 PF= 0.51 tot= -515.1%
S1b bo55                           n= 408  win= 43.4%  PF= 1.82  tot=  +930.1%  avg= +2.28%  hold= 11 | H1 PF= 2.96 tot=+1105.4% | H2 PF= 0.69 tot= -175.2%
S1c reg200/gap5                    n= 359  win= 37.6%  PF= 1.25  tot=  +306.7%  avg= +0.85%  hold= 12 | H1 PF= 1.69 tot= +487.5% | H2 PF= 0.65 tot= -180.7%
S1d stop2.0                        n= 630  win= 34.0%  PF= 1.04  tot=   +76.6%  avg= +0.12%  hold=  7 | H1 PF= 1.53 tot= +521.2% | H2 PF= 0.51 tot= -444.6%
S1e stop3.0                        n= 625  win= 38.7%  PF= 1.29  tot=  +645.8%  avg= +1.03%  hold= 15 | H1 PF= 2.13 tot=+1160.4% | H2 PF= 0.58 tot= -514.6%
S1f 无过滤器                           n= 640  win= 38.1%  PF= 1.20  tot=  +415.8%  avg= +0.65%  hold= 10 | H1 PF= 1.92 tot= +950.8% | H2 PF= 0.50 tot= -535.0%
S1a+仅止损出场                          n= 612  win= 38.7%  PF= 1.20  tot=  +407.2%  avg= +0.67%  hold= 12 | H1 PF= 1.91 tot= +908.9% | H2 PF= 0.53 tot= -501.7%
S1b+仅止损出场                          n= 402  win= 44.0%  PF= 1.88  tot=  +974.9%  avg= +2.43%  hold= 11 | H1 PF= 3.17 tot=+1155.6% | H2 PF= 0.69 tot= -180.7%
S1c+仅止损出场                          n= 357  win= 37.8%  PF= 1.24  tot=  +299.4%  avg= +0.84%  hold= 13 | H1 PF= 1.71 tot= +497.8% | H2 PF= 0.63 tot= -198.4%
...
== 优胜者 (按 min(H1,H2) PF): S1 -> S1b bo55 · S2 -> S2d =b, tp10/hold12 ==
