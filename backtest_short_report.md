# v2.0-Short 策略回测报告
_2026-07-15T05:44:07.744079Z · LBank hour4 · 2000 bars_
```
...
== 稳健性扫描: cell = ret/DD (满仓基线=6.44, *=优于基线, min倍数=0.25) ==
  N \ floor/ceil    0.8/1.3   0.9/1.4   1.0/1.5   1.0/1.8
  N=10              4.30      4.50      4.76      4.98 
  N=15              6.91*     7.34*     7.79*     8.90*
  N=20              8.11*     8.62*     8.77*     9.30*
  N=25              5.73      6.04      5.86      5.98 
  N=30              5.10      5.42      5.37      5.65 
  N=40              4.14      3.76      3.81      4.10 
  -> 24 组里 8 组优于基线; 连成片=真本事, 零星尖峰=过拟合

== $2000 纸账户实际金额视角 (meme 5-12%/单, 无杠杆, 复利; 回撤=已实现净值) ==
  满仓基线                   期末 $    2,708 (   +35%)  最大回撤 $    503 (16.6%)
  N20 缩放 0.9/1.4/0.25    期末 $    2,803 (   +40%)  最大回撤 $    315 (10.1%)
  N15 缩放 0.9/1.4/0.25    期末 $    2,678 (   +34%)  最大回撤 $    343 (11.4%)
```
